          ...
          <Col className="d-flex-row justify-content-between border border-success">
            ...
            {selectedJob && (
              <div>
                ...
                <img src={selectedJob.employer_logo} alt={selectedJob.employer_name} style={{width:"3rem"}} />
                <p>
                {selectedJob.employer_name} - {selectedJob.job_city}

                </p>
                <hr />
                <p><AccessTimeIcon/> -  {getTimeDifference(selectedJob.job_posted_at_timestamp)}   - <WorkIcon/> {selectedJob.job_employment_type}</p>
